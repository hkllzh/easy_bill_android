package com.hkllzh.easybill.util.delegate

import android.annotation.SuppressLint
import android.content.Context
import android.content.SharedPreferences
import com.hkllzh.easybill.EasyBillApplication
...
class Preference<T>(val name: String, val default: T) {
    ...
    val prefs: SharedPreferences by lazy { EasyBillApplication.instance.applicationContext.getSharedPreferences(name, Context.MODE_PRIVATE) }
